...
export default function ApexEdu() {
  return (
    <>
      <div class="section wf-section snipcss-9n6fF">
      ...
      <div class="container snipcss-6QAMP">
        <div class="featured-post-wrapper-jimmy w-dyn-list">
          <div role="list" class="w-dyn-items w-row">
            <div
              role="listitem"
              class="collection-item-2 w-dyn-item w-col w-col-6"
            >
              <div class="w-layout-grid panel panel-wide panel-wide-jimmy">
                <a href="mutual" class="panel-image-link w-inline-block">
                  <img
                    src="https://img.freepik.com/premium-photo/growth-money-arrow-success-financial-business-coin-concept-investment-earnings-background-with-profit-graph-finance-development-increase-economic-market-chart-digital-stock-currency-strategy_79161-2472.jpg"
                    alt=""
                    sizes="(max-width: 479px) 84vw, (max-width: 767px) 400px, (max-width: 991px) 43vw, (max-width: 1919px) 45vw, 43vw"
                    srcset="https://img.freepik.com/premium-photo/growth-money-arrow-success-financial-business-coin-concept-investment-earnings-background-with-profit-graph-finance-development-increase-economic-market-chart-digital-stock-currency-strategy_79161-2472.jpg 500w,https://img.freepik.com/premium-photo/growth-money-arrow-success-financial-business-coin-concept-investment-earnings-background-with-profit-graph-finance-development-increase-economic-market-chart-digital-stock-currency-strategy_79161-2472.jpg 721w"
                    class="panel-top-image style-T6N5O"
                    id="style-T6N5O"
                  ></img>
                </a>
                <div
                  data-w-id="ef69d4c7-6c03-4a00-a9a0-ff6599f02ddc"
                  class="panel-body style-c6Exa"
                  id="style-c6Exa"
                >
                  <div class="blog-panel-foot">
                    <div class="blog-panel-meta-text">
                      <div>Learn Topics about Investing</div>
                      <div>Mutual funds and Many more</div>
                      <div class="row">
            ...
            >
              <div class="w-layout-grid panel panel-wide panel-wide-jimmy">
                <a href="investing2" class="panel-image-link w-inline-block">
                  <img
